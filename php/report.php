...
// Function to display a single purchase row
function showPurchaseRow($seq_no, $row) {
  ?>
  <tr>
      <td><?php echo $seq_no; ?></td>
      <td><?php echo isset($row['PURCHASE_DATE']) ? $row['PURCHASE_DATE'] : ''; ?></td>
      <td><?php echo isset($row['VOUCHER_NUMBER']) ? $row['VOUCHER_NUMBER'] : ''; ?></td>
      <td><?php echo isset($row['INVOICE_NO']) ? $row['INVOICE_NO'] : ''; ?></td> <!-- Display Invoice Number -->
